...
dme = atom.getDipoleMatrixElement(pstate1n, 1, pstate1j, pstate1mj, np, 0, 0.5, 0.5,0)
...
print("%.2f us : Lifetime of %.0f with BB"% (10**6 *atom.getStateLifetime(np,0,0.5, temperature=300, includeLevelsUpTo=40),np) )
print("%.2f us : Lifetime of %.0f with BB"% (10**6 *atom.getStateLifetime(ni,0,0.5, temperature=300, includeLevelsUpTo=40),ni) )
